...
public class BNode<E extends Comparable<E>> {
	...
	public boolean contains(E e) {
		...
		else return (compareResult<0) ? left.contains(e) : right.contains(e);
	}
	...
	public void ancestors(E data1, List<E> re){
		if (!contains(data1)) return;
		int compareResult = data1.compareTo(data);
		if(compareResult > 0) {
			re.add(data);
			if (right!=null) right.ancestors(data1, re);
		}
		if (compareResult < 0) {
			re.add(data);
			if (left!=null) left.ancestors(data1, re);
		}
	}
